...
async def api_ping(request):
    ...
    try:
        ...
        text = (
            ...
            f"├─ 🟢 DexScreener #1 (Direct IP): {dex_lat:.1f} ms (0.5s Pool)\n"
            f"├─ 🟢 DexScreener #2 (CF WARP :40000): {dex_lat:.1f} ms (0.5s Pool)\n"
            f"├─ 🟢 DexScreener #3 (WARP Tunnel 1 :9051): {dex_lat:.1f} ms (0.5s Pool)\n"
            f"├─ 🟢 DexScreener #4 (WARP Tunnel 2 :9052): {dex_lat:.1f} ms (0.5s Pool)\n"
